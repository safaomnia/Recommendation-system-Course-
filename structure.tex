...
\definecolor{ocre}{HTML}{004985} % Define the orange color used for highlighting throughout the book
...
\rfoot{\sffamily\normalsize Système de recommandation} % Font setting for the page number
\lfoot{\sffamily\normalsize\bfseries Şąfą Şoųlį}
...
\newtheorem{applicationT}{Application manuelle :}
\theoremstyle{ocrenum}
...
\newenvironment{application}{\begin{dBox}\begin{applicationT}}{\end{applicationT}\end{dBox}}	
